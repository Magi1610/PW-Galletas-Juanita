    ...
    <section id="nosotros" className="about">
      ...
      <div className="about-content">
        ...
        <p className="about-text">
          Desde 1985 elaboramos cada galleta con las recetas tradicionales con las que nació
          Galletas Juanita. Nos enfocamos en la calidad, el sabor y la confianza de nuestros
          clientes.
        </p>
